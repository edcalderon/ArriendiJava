            ...
            <div class="form-register-with-email">
                ...
                <div class="form-white-background">
                    ...
                    <div class="form-row">
                        <label>
                            <span>Firstname</span>
                            <input type="text" name="txt_firstname" id="fname" placeholder="ingresa firstname">
                        </label>
                    </div>
					<div class="form-row">
                        <label>
                            <span>Lastname</span>
                            <input type="text" name="txt_lastname" id="lname" placeholder="ingresa lastname">
                        </label>
                    </div>
                    ...
                    <div class="form-row">
                        <label>
                            <span>Email</span>
                            <input type="text" name="txt_email" id="email" placeholder="ingresa email">
                        </label>
                    </div>
                    ...
                    <div class="form-row">
                        <label>
                            <span>Password</span>
                            <input type="password" name="txt_password" id="password" placeholder="ingresa password">
                        </label>
                    </div>
                ...
                <a href="index2.jsp" class="form-log-in-with-existing">¿Ya tienes cuenta? <b> Ingresa Aquí </b></a>
